...
function Message() {
    ...
    //redirect to my mail/:id page
    const navigate = useNavigate()

    const openMail = () => {
        navigate("/mail/145ere145")

    }

  return (
    <div onClick={openMail} className='group flex items-start justify-between border-b border-gray-300 px-4 py-3 text-sm hover:cursor-pointer hover:shadow-md '>
